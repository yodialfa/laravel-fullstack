            ...
            <thead>
                <tr>
                    <th width="50%" colspan="2">
                        <h2 class="text-start">{{ $title }}</h2>
                        <h3><a href="www.cahaya-nusantara.co.id">www.cahaya-nusantara.co.id</a></h3>
                    </th>
                    <th width="50%" colspan="2" class="text-end company-data">
                        
                        <span><img class="barcode" src="data:image/png;base64,{{ base64_encode($barcode) }}" alt="Barcode"></span> <br>
                        <span>{{ $transaksi['no_resi'] }}</span> <br>
                        <span>Address: Jl. Jenderal Ahmad Yani No. 288 Kota Bandung 082219082230</span> <br>
                    </th>
                </tr>
                <tr class="bg-blue">
