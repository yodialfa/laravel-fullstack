    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
       <ul class="space-y-2 font-medium">
         ...
         <ul id="dropdown-cabang" class="hidden py-2 space-y-2">
               ...
               <li>
                  <a href="{{ route('cabang.sorting-list-sortir') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">List Sortir Pengantaran</a>
               </li>
               <li>
               ...
               <li>
                  <a href="{{ route('cabang.pengantaran-listview') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">List Pengantaran Kurir</a>
               </li>
