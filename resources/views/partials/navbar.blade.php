  ...
  <nav class="bg-transparent border-transparent font-kanit dark:bg-red dark:border-gray-700">
    <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto px-4 py-2.5">
      <a href="#" class="flex items-center">
        ...
        <span class="self-center text-3xl font-semibold  font-kanit whitespace-nowrap text-white">Cahaya Express</span>
      </a>
              ...
              {{-- auth cek jika admin --}}
                @if (auth()->user())
                  <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                    ...
                    <li>
                      <a href="{{ route('ganti-pass') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Settings</a>
                    </li>
                    <li>
