    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-20">
        <div class="relative overflow-x-auto bg-white shadow-md sm:rounded-lg min-h-full">
            ...
            <div class="flex justify-center m-5">
                <button type="button" id="btnModal" data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="hidden text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center ml-3">Buat Laporan Pengantaran</button>
...
<script>
    ...
    $('#submitBtn').click(function(){
        ...
        serverSide: true,
        ajax: {
            url : "{{ route('cabang.pengantaran-data') }}",
            data : {kec:kec},
        ...
        if(confirm("Apakah sudah yakin ingin mengupdate data?"))
        {
            ...
            if(selectedValues.length > 0)
            {
                ...
                $.ajax({
                    url:'{{ route('cabang.pengantaran-shipment') }}',
