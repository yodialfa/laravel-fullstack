...
var Instances = (
  ...
  function() {
    ...
    Instances2.prototype.addInstance = function(component, instance, id, forceOverride) {
      if (forceOverride === void 0) {
        forceOverride = false;
      }
...
var Accordion = (
  /** @class */
  function() {
    function Accordion2(accordionEl, items, options) {
      ...
      this.init();
      instances_default.addInstance("Accordion", this, this._accordionEl.id, true);
    }
    ...
    Accordion2.prototype.removeInstance = function() {
      instances_default.removeInstance("Accordion", this._accordionEl.id);
    };
...
var Collapse = (
  ...
  function() {
    function Collapse2(targetEl, triggerEl, options) {
      ...
      this._initialized = false;
      this.init();
      instances_default.addInstance("Collapse", this, this._targetEl.id, true);
    }
    ...
    Collapse2.prototype.removeInstance = function() {
      instances_default.removeInstance("Collapse", this._targetEl.id);
    };
...
var Carousel = (
  /** @class */
  function() {
    function Carousel2(carouselEl, items, options) {
      ...
      this._initialized = false;
      this.init();
      instances_default.addInstance("Carousel", this, this._carouselEl.id, true);
    }
    ...
    Carousel2.prototype.removeInstance = function() {
      instances_default.removeInstance("Carousel", this._carouselEl.id);
    };
...
var Dismiss = (
  ...
  function() {
    function Dismiss2(targetEl, triggerEl, options) {
      ...
      this._initialized = false;
      this.init();
      instances_default.addInstance("Dismiss", this, this._targetEl.id, true);
    }
    ...
    Dismiss2.prototype.removeInstance = function() {
      instances_default.removeInstance("Dismiss", this._targetEl.id);
    };
...
var Dropdown = (
  ...
  function() {
    function Dropdown2(targetElement, triggerElement, options) {
      ...
      this._initialized = false;
      this.init();
      instances_default.addInstance("Dropdown", this, this._targetEl.id, true);
    }
    ...
    Dropdown2.prototype.removeInstance = function() {
      instances_default.removeInstance("Dropdown", this._targetEl.id);
    };
...
var Modal = (
  ...
  function() {
    function Modal2(targetEl, options) {
      ...
      this._initialized = false;
      this.init();
      instances_default.addInstance("Modal", this, this._targetEl.id, true);
    }
    ...
    Modal2.prototype.removeInstance = function() {
      instances_default.removeInstance("Modal", this._targetEl.id);
    };
...
function initModals() {
  document.querySelectorAll("[data-modal-target]").forEach(function($triggerEl) {
    ...
    if ($modalEl) {
      ...
      if (instances_default.instanceExists("Modal", $modalEl.getAttribute("id"))) {
        new Modal($modalEl, {
  ...
  document.querySelectorAll("[data-modal-toggle]").forEach(function($triggerEl) {
    ...
    if ($modalEl) {
      ...
      var modal_1;
      if (instances_default.instanceExists("Modal", $modalEl.getAttribute("id"))) {
        modal_1 = instances_default.getInstance("Modal", $modalEl.getAttribute("id"));
      } else {
        {
  ...
  document.querySelectorAll("[data-modal-show]").forEach(function($triggerEl) {
    ...
    if ($modalEl) {
      if (instances_default.instanceExists("Modal", $modalEl.getAttribute("id"))) {
        var modal_2 = instances_default.getInstance("Modal", $modalEl.getAttribute("id"));
        $triggerEl.addEventListener("click", function() {
          modal_2.show();
        });
      } else {
  ...
  document.querySelectorAll("[data-modal-hide]").forEach(function($triggerEl) {
    ...
    if ($modalEl) {
      if (instances_default.instanceExists("Modal", $modalEl.getAttribute("id"))) {
        var modal_3 = instances_default.getInstance("Modal", $modalEl.getAttribute("id"));
        $triggerEl.addEventListener("click", function() {
          modal_3.hide();
        });
      } else {
...
var Drawer = (
  ...
  function() {
    function Drawer2(targetEl, options) {
      ...
      this._initialized = false;
      this.init();
      instances_default.addInstance("Drawer", this, this._targetEl.id, true);
    }
    ...
    Drawer2.prototype.removeInstance = function() {
      instances_default.removeInstance("Drawer", this._targetEl.id);
    };
...
function initDrawers() {
  document.querySelectorAll("[data-drawer-target]").forEach(function($triggerEl) {
    ...
    if ($drawerEl) {
      ...
      if (!instances_default.instanceExists("Drawer", $drawerEl.getAttribute("id"))) {
        new Drawer($drawerEl, {
  ...
  document.querySelectorAll("[data-drawer-toggle]").forEach(function($triggerEl) {
    ...
    var $drawerEl = document.getElementById(drawerId);
    if ($drawerEl) {
      var drawer_1 = instances_default.getInstance("Drawer", $drawerEl.getAttribute("id"));
      if (drawer_1) {
        $triggerEl.addEventListener("click", function() {
          drawer_1.toggle();
        });
  ...
  document.querySelectorAll("[data-drawer-dismiss], [data-drawer-hide]").forEach(function($triggerEl) {
    ...
    var $drawerEl = document.getElementById(drawerId);
    if ($drawerEl) {
      var drawer_2 = instances_default.getInstance("Drawer", $drawerEl.getAttribute("id"));
      if (drawer_2) {
        $triggerEl.addEventListener("click", function() {
          drawer_2.hide();
        });
  ...
  document.querySelectorAll("[data-drawer-show]").forEach(function($triggerEl) {
    ...
    var $drawerEl = document.getElementById(drawerId);
    if ($drawerEl) {
      var drawer_3 = instances_default.getInstance("Drawer", $drawerEl.getAttribute("id"));
      if (drawer_3) {
        $triggerEl.addEventListener("click", function() {
          drawer_3.show();
        });
...
var Tabs = (
  /** @class */
  function() {
    function Tabs2(accordionEl, items, options) {
      if (accordionEl === void 0) {
        accordionEl = null;
      }
      if (items === void 0) {
      ...
      this._initialized = false;
      this.init();
      instances_default.addInstance("Tabs", this, this._accordionEl.id, true);
    }
    ...
    Tabs2.prototype.removeInstance = function() {
      this.destroy();
      instances_default.removeInstance("Tabs", this._accordionEl.id);
    };
...
var Tooltip = (
  ...
  function() {
    function Tooltip2(targetEl, triggerEl, options) {
      ...
      this._initialized = false;
      this.init();
      instances_default.addInstance("Tooltip", this, this._targetEl.id, true);
    }
    ...
    Tooltip2.prototype.removeInstance = function() {
      instances_default.removeInstance("Tooltip", this._targetEl.id);
    };
...
var Popover = (
  ...
  function() {
    function Popover2(targetEl, triggerEl, options) {
      ...
      this._initialized = false;
      this.init();
      instances_default.addInstance("Popover", this, this._targetEl.id, true);
    }
    ...
    Popover2.prototype.removeInstance = function() {
      instances_default.removeInstance("Popover", this._targetEl.id);
    };
...
var Dial = (
  ...
  function() {
    function Dial2(parentEl, triggerEl, targetEl, options) {
      ...
      this._initialized = false;
      this.init();
      instances_default.addInstance("Dial", this, this._targetEl.id, true);
    }
    ...
    Dial2.prototype.removeInstance = function() {
      instances_default.removeInstance("Dial", this._targetEl.id);
    };
